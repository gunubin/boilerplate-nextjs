...
type ValueObjectSchemaProp<TValueObject extends ValueObject> = {
  ...
  ruleMessages?: Record<ValueObjectRuleName<ValueObjectRules<TValueObject>[number]>, string>;
...
export type FieldValuesBySchema<T> = T extends ValidationSchema<infer U> ? U : never;
