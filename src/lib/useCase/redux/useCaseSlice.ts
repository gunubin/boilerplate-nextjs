...
type SucceededAction = PayloadAction<UseCaseEntity, string, {useCaseResult: any}>;
...
const selectProcessingById = createSelector(baseSelectors.selectById, (useCase) =>
  useCase ? isUseCaseProcessing(useCase) : false
);
